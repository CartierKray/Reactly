        ...
        <NavigationMenuList className="space-x-2 flex items-center">
          {menuItems.map((item) => (
            <NavigationMenuItem key={item.label}>
              {item.dropdown ? (
                <>
                  <NavigationMenuTrigger className="px-3 py-2 text-[11px] font-normal uppercase tracking-wide hover:tracking-wider hover:font-semibold transition-all duration-300 ease-in-out">
                    {item.label}
                  </NavigationMenuTrigger>
                  <NavigationMenuContent className="border border-[#f0f0f0] dark:border-white/10  px-5 py-6 text-white shadow-xl max-w-max">
                    {item.label === "DIENSTEN" && (
