...
export default function Footer() {
  ...
  return (
    <footer className="bg-gradient-to-b from-[#191c1f] to-[#191c1f] relative overflow-x-clip overflow-y-clip text-white px-6 pb-2.5">
      {/* Smoke Layers */}
      ...
      {/* <div className="max-w-7xl mx-auto  border-t border-white/10 relative z-20">
