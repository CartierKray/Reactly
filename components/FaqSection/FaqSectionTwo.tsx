      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="space-y-4 pt-5 relative">
          ...
          {!showAll && faqs.length > initialVisibleCount && (
            <div className="absolute -bottom-1 left-0 w-full h-44 bg-gradient-to-t from-[#fff] dark:from-[#000]  dark:via-[#000]/80 to-transparent flex justify-center items-end pb-6 pointer-events-none z-10">
              <button
